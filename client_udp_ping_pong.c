...
int main(int argc, char** argv) {
    traiter_commande(argc == 4, argv[0], "127.0.0.1:8080 \n mauvais nombre d'arguments");
    traiter_commande(inet_addr(argv[1]) != INADDR_NONE, argv[0], "10.0.20.15 8080 \n 10.0.20.15  est une adresse IP au format décimal pointé");
    traiter_commande(atoi(argv[2]) > 1024 && atoi(argv[2]) < 65536, argv[0], "10.0.20.15 8080 \n 8080 est un port non réservé");
